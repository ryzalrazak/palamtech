...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1991673653ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=customer">`palamtech`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=compenent">`palamtech`.`compenent`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=category">`palamtech`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=admin">`palamtech`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=rule">`palamtech`.`rule`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=pc">`palamtech`.`pc`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6f7569426d462429224434412e24272d">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="palamtech" targettable="admin">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="palamtech" targettable="category">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `category`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="palamtech" targettable="compenent">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `compenent`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="palamtech" targettable="customer">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
