...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=420693392ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=facts">`palamtech`.`facts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=rule">`palamtech`.`rule`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=pcbuild">`palamtech`.`pcbuild`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=feedbacks">`palamtech`.`feedbacks`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=buildpc">`palamtech`.`buildpc`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=component">`palamtech`.`component`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=category">`palamtech`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=customer">`palamtech`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=palamtech&table=admin">`palamtech`.`admin`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="532668632c7e4630673856393d683042">
